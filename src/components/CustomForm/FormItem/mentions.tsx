...
const MentionsControl: React.FC<IControlProps> = React.forwardRef((props, ref) => {
  const { form, name, dict = [], onChange, fetchConfig = {} as IControlProps['fetchConfig'], ...controlProps } = props;
