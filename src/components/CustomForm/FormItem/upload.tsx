...
const UploadControl: React.FC<IUploadProps> = React.forwardRef((props, ref) => {
  const { form, name, onChange, files, ...controlProps } = props;
  ...
  return (
    <Fragment>
      <Upload {...uploadProps} fileList={fileList} onChange={handleChange} onPreview={handlePreview} beforeUpload={handleBeforeUpload}>
